...
public class SoapHelper {
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        IssueData createdIssueData = getIssueDataById(mc, issueId);
    ...
    private IssueData getIssueDataById(MantisConnectPortType mc, BigInteger issueId) throws RemoteException {
    ...
    public Issue getIssueById(int issueId) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        IssueData issueData = getIssueDataById(mc, BigInteger.valueOf(issueId));
